...
import CampaignEachDetail from './CampaignEachDetail.jsx';
				...
				<div>
					<Nav>
						<LinkContainer to="/campaign" >
							<NavItem eventKey={5}>Campaign</NavItem>
						</LinkContainer>
					</Nav>
					<Nav>
			...
			<Router history={browserHistory}>
				<div>
					...
					<Grid>
						...
						<Route path="/campaignAddone" component={CampaignAddOne} />
						<Route path="/campaignEachDetail/:campaignId" component={CampaignEachDetail} />
